...
static const RGBQUAD grayscalepalette[256] =
{
...
static const RGBQUAD rgb332palette[256] =
{
	{0,0,0,0},       {85,0,0,0},      {170,0,0,0},     {255,0,0,0},     {0,36,0,0},      {85,36,0,0},     {170,36,0,0},    {255,36,0,0},
	{0,72,0,0},      {85,72,0,0},     {170,72,0,0},    {255,72,0,0},    {0,109,0,0},     {85,109,0,0},    {170,109,0,0},   {255,109,0,0},
	{0,145,0,0},     {85,145,0,0},    {170,145,0,0},   {255,145,0,0},   {0,182,0,0},     {85,182,0,0},    {170,182,0,0},   {255,182,0,0},
	{0,218,0,0},     {85,218,0,0},    {170,218,0,0},   {255,218,0,0},   {0,255,0,0},     {85,255,0,0},    {170,255,0,0},   {255,255,0,0},
	{0,0,36,0},      {85,0,36,0},     {170,0,36,0},    {255,0,36,0},    {0,36,36,0},     {85,36,36,0},    {170,36,36,0},   {255,36,36,0},
	{0,72,36,0},     {85,72,36,0},    {170,72,36,0},   {255,72,36,0},   {0,109,36,0},    {85,109,36,0},   {170,109,36,0},  {255,109,36,0},
	{0,145,36,0},    {85,145,36,0},   {170,145,36,0},  {255,145,36,0},  {0,182,36,0},    {85,182,36,0},   {170,182,36,0},  {255,182,36,0},
	{0,218,36,0},    {85,218,36,0},   {170,218,36,0},  {255,218,36,0},  {0,255,36,0},    {85,255,36,0},   {170,255,36,0},  {255,255,36,0},
	{0,0,72,0},      {85,0,72,0},     {170,0,72,0},    {255,0,72,0},    {0,36,72,0},     {85,36,72,0},    {170,36,72,0},   {255,36,72,0},
	{0,72,72,0},     {85,72,72,0},    {170,72,72,0},   {255,72,72,0},   {0,109,72,0},    {85,109,72,0},   {170,109,72,0},  {255,109,72,0},
	{0,145,72,0},    {85,145,72,0},   {170,145,72,0},  {255,145,72,0},  {0,182,72,0},    {85,182,72,0},   {170,182,72,0},  {255,182,72,0},
	{0,218,72,0},    {85,218,72,0},   {170,218,72,0},  {255,218,72,0},  {0,255,72,0},    {85,255,72,0},   {170,255,72,0},  {255,255,72,0},
	{0,0,109,0},     {85,0,109,0},    {170,0,109,0},   {255,0,109,0},   {0,36,109,0},    {85,36,109,0},   {170,36,109,0},  {255,36,109,0},
	{0,72,109,0},    {85,72,109,0},   {170,72,109,0},  {255,72,109,0},  {0,109,109,0},   {85,109,109,0},  {170,109,109,0}, {255,109,109,0},
	{0,145,109,0},   {85,145,109,0},  {170,145,109,0}, {255,145,109,0}, {0,182,109,0},   {85,182,109,0},  {170,182,109,0}, {255,182,109,0},
	{0,218,109,0},   {85,218,109,0},  {170,218,109,0}, {255,218,109,0}, {0,255,109,0},   {85,255,109,0},  {170,255,109,0}, {255,255,109,0},
	{0,0,145,0},     {85,0,145,0},    {170,0,145,0},   {255,0,145,0},   {0,36,145,0},    {85,36,145,0},   {170,36,145,0},  {255,36,145,0},
	{0,72,145,0},    {85,72,145,0},   {170,72,145,0},  {255,72,145,0},  {0,109,145,0},   {85,109,145,0},  {170,109,145,0}, {255,109,145,0},
	{0,145,145,0},   {85,145,145,0},  {170,145,145,0}, {255,145,145,0}, {0,182,145,0},   {85,182,145,0},  {170,182,145,0}, {255,182,145,0},
	{0,218,145,0},   {85,218,145,0},  {170,218,145,0}, {255,218,145,0}, {0,255,145,0},   {85,255,145,0},  {170,255,145,0}, {255,255,145,0},
	{0,0,182,0},     {85,0,182,0},    {170,0,182,0},   {255,0,182,0},   {0,36,182,0},    {85,36,182,0},   {170,36,182,0},  {255,36,182,0},
	{0,72,182,0},    {85,72,182,0},   {170,72,182,0},  {255,72,182,0},  {0,109,182,0},   {85,109,182,0},  {170,109,182,0}, {255,109,182,0},
	{0,145,182,0},   {85,145,182,0},  {170,145,182,0}, {255,145,182,0}, {0,182,182,0},   {85,182,182,0},  {170,182,182,0}, {255,182,182,0},
	{0,218,182,0},   {85,218,182,0},  {170,218,182,0}, {255,218,182,0}, {0,255,182,0},   {85,255,182,0},  {170,255,182,0}, {255,255,182,0},
	{0,0,218,0},     {85,0,218,0},    {170,0,218,0},   {255,0,218,0},   {0,36,218,0},    {85,36,218,0},   {170,36,218,0},  {255,36,218,0},
	{0,72,218,0},    {85,72,218,0},   {170,72,218,0},  {255,72,218,0},  {0,109,218,0},   {85,109,218,0},  {170,109,218,0}, {255,109,218,0},
	{0,145,218,0},   {85,145,218,0},  {170,145,218,0}, {255,145,218,0}, {0,182,218,0},   {85,182,218,0},  {170,182,218,0}, {255,182,218,0},
	{0,218,218,0},   {85,218,218,0},  {170,218,218,0}, {255,218,218,0}, {0,255,218,0},   {85,255,218,0},  {170,255,218,0}, {255,255,218,0},
	{0,0,255,0},     {85,0,255,0},    {170,0,255,0},   {255,0,255,0},   {0,36,255,0},    {85,36,255,0},   {170,36,255,0},  {255,36,255,0},
	{0,72,255,0},    {85,72,255,0},   {170,72,255,0},  {255,72,255,0},  {0,109,255,0},   {85,109,255,0},  {170,109,255,0}, {255,109,255,0},
	{0,145,255,0},   {85,145,255,0},  {170,145,255,0}, {255,145,255,0}, {0,182,255,0},   {85,182,255,0},  {170,182,255,0}, {255,182,255,0},
	{0,218,255,0},   {85,218,255,0},  {170,218,255,0}, {255,218,255,0}, {0,255,255,0},   {85,255,255,0},  {170,255,255,0}, {255,255,255,0}
};
...
HRESULT glTexture_GetDC(glTexture *This, GLint level, HDC *hdc, glDirectDrawPalette *palette)
{
	...
	if (This->levels[level].ddsd.ddpfPixelFormat.dwFlags & DDPF_FOURCC) return DDERR_NODC;
	if (This->levels[level].ddsd.ddpfPixelFormat.dwRGBBitCount == 4)
		This->levels[level].bitmapinfo->bmiHeader.biWidth = This->levels[level].ddsd.lPitch * 2;
	else if (This->levels[level].ddsd.ddpfPixelFormat.dwRGBBitCount == 2)
		This->levels[level].bitmapinfo->bmiHeader.biWidth = This->levels[level].ddsd.lPitch * 4;
	else if (This->levels[level].ddsd.ddpfPixelFormat.dwRGBBitCount == 1)
		This->levels[level].bitmapinfo->bmiHeader.biWidth = This->levels[level].ddsd.lPitch * 8;
	else This->levels[level].bitmapinfo->bmiHeader.biWidth = This->levels[level].ddsd.lPitch /
		(This->levels[level].bitmapinfo->bmiHeader.biBitCount / 8);
	if ((This->levels[level].ddsd.ddpfPixelFormat.dwRGBBitCount == 1) && palette)
	{
		This->levels[level].bitmapinfo->bmiHeader.biClrUsed = 2;
		memcpy(colors, palette->palette, 8);
		for (i = 0; i < 2; i++)
			colors[i] = ((colors[i] & 0x0000FF) << 16) | (colors[i] & 0x00FF00) | ((colors[i] & 0xFF0000) >> 16);
		memcpy(This->levels[level].bitmapinfo->bmiColors, colors, 8);
	}
	if ((This->levels[level].ddsd.ddpfPixelFormat.dwRGBBitCount == 2) && palette)
	{
		This->levels[level].bitmapinfo->bmiHeader.biClrUsed = 4;
		memcpy(colors, palette->palette, 16);
		for (i = 0; i < 4; i++)
			colors[i] = ((colors[i] & 0x0000FF) << 16) | (colors[i] & 0x00FF00) | ((colors[i] & 0xFF0000) >> 16);
		memcpy(This->levels[level].bitmapinfo->bmiColors, colors, 16);
	}
	if ((This->levels[level].ddsd.ddpfPixelFormat.dwRGBBitCount == 4) && palette)
	{
		This->levels[level].bitmapinfo->bmiHeader.biClrUsed = 16;
		memcpy(colors, palette->palette, 64);
		for (i = 0; i < 16; i++)
			colors[i] = ((colors[i] & 0x0000FF) << 16) | (colors[i] & 0x00FF00) | ((colors[i] & 0xFF0000) >> 16);
		memcpy(This->levels[level].bitmapinfo->bmiColors, colors, 64);
	}
	if (This->levels[level].ddsd.ddpfPixelFormat.dwRGBBitCount == 8)
	{
		This->levels[level].bitmapinfo->bmiHeader.biClrUsed = 256;
		if (palette)
		{
		...
		else if ((This->levels[level].ddsd.ddpfPixelFormat.dwRBitMask == 0xE0) &&
			(This->levels[level].ddsd.ddpfPixelFormat.dwGBitMask == 0x1C) &&
			(This->levels[level].ddsd.ddpfPixelFormat.dwBBitMask == 0x3))
			memcpy(This->levels[level].bitmapinfo->bmiColors, rgb332palette, 1024);
		else if (This->levels[level].ddsd.ddpfPixelFormat.dwFlags & DDPF_LUMINANCE)
			memcpy(This->levels[level].bitmapinfo->bmiColors, grayscalepalette, 1024);
	}
	...
	else if ((This->levels[level].ddsd.ddpfPixelFormat.dwRGBBitCount == 24) ||
		(This->levels[level].ddsd.ddpfPixelFormat.dwRGBBitCount == 32))
	{
		if ((This->levels[level].ddsd.ddpfPixelFormat.dwRBitMask == 0xFF) &&
			(This->levels[level].ddsd.ddpfPixelFormat.dwGBitMask == 0xFF00) &&
			(This->levels[level].ddsd.ddpfPixelFormat.dwBBitMask == 0xFF0000))
			This->levels[level].bitmapinfo->bmiHeader.biCompression = BI_BITFIELDS;
		else if ((This->levels[level].ddsd.ddpfPixelFormat.dwRBitMask == 0xFF0000) &&
			(This->levels[level].ddsd.ddpfPixelFormat.dwGBitMask == 0xFF00) &&
			(This->levels[level].ddsd.ddpfPixelFormat.dwBBitMask == 0xFF))
			This->levels[level].bitmapinfo->bmiHeader.biCompression = BI_RGB;
		else
		{
